...
The output MyST anywidget can be loaded into a MyST project via an `anywidget` directive. You can publish the built plugin to a public artifact repository, such as as a GitHub release artifact, and users can directly link to it in their anywidget directive:
